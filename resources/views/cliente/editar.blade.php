                  ...
                  <table class="table table-condensed">
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" class="form-control input-sm" name="name" value="{{$usuario->name}}"></td>
                      </tr>
                      <tr>
                      	<tr>
                        <td class='col-md-3'>Email</td>
                        <td><input type="text" class="form-control input-sm" name="email" value="{{$usuario->email}}"></td>
                      </tr>
